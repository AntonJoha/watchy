...
//weather api
#define CITY_NAME "KARLSTAD" //if your city name has a space, replace with '+'
#define COUNTRY_CODE "SE"
#define OPENWEATHERMAP_APIKEY "9c71fc6ab93f7c02960dc090a31f3cb1" //"9c71fc6ab93f7c02960dc090a31f3cb1"// use your own API key :)
